...
function checkStorage(){
	...
	if(localStorage.getItem("myData") != null){
		...
		myData = [
			{"dealId" : 1, "client_name" : "IBM", "project_name" : "Project 1", "project_manager" : "Raman", "project_cost" : 1000},
			{"dealId" : 2, "client_name" : "Philips", "project_name" : "Project 2", "project_manager" : "Rajnish", "project_cost" : 10500},
			{"dealId" : 3, "client_name" : "Cisco", "project_name" : "Project 3", "project_manager" : "Shankar", "project_cost" : 500},
			{"dealId" : 4, "client_name" : "Google", "project_name" : "Project 4", "project_manager" : "Kartikey", "project_cost" : 9000},
			{"dealId" : 5, "client_name" : "Cisco", "project_name" : "Project5", "project_manager" : "Rahul", "project_cost" : 11000}
		]	
	}
...
function CreateTableFromJSON() {    
    ...
    for (var i = 0; i < myData.length; i++) {
        ...
        //TODO: Complete this
        var tabCell = tr.insertCell(-1);
        tabCell.innerHTML = '<button onclick="DeleteRow(' + myData[i].dealId + ')"> <img src="cross.png" width="12px" height="12px"> </button>'
    }
